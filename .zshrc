...
alias restic-router='restic -r rclone:router:FRITZ.NAS/Samsung-PortableSSDT5-01/johan/restic -o "rclone.program=$HOME/.config/restic/restic-rclone-router.sh" --password-command "secret-tool lookup service restic"'
